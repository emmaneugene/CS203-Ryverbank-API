...
public class RyverbankApiApplication {
    public static void main(String[] args) {
        ...
        User analyst1 = new User(4, "analyst 1", "S1234567D", "00000000", "nil", "analyst_1", encoder.encode("01_analyst_01"), "ROLE_ANALYST", true);
        User analyst2 = new User(5, "analyst 2", "S1234567D", "00000000", "nil", "analyst_2", encoder.encode("02_analyst_02"), "ROLE_ANALYST", true);
